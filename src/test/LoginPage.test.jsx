...
describe('LoginPage - render', () => {
  it('shows login form by default', () => {
    render(<LoginPage onLogin={noop} onRegister={noop} onReset={noop} />)
...
describe('LoginPage - callbacks', () => {
  it('calls onLogin with email and password', async () => {
    ...
    render(<LoginPage onLogin={onLogin} onRegister={noop} onReset={noop} />)
  ...
  it('calls onRegister with email and password', async () => {
    ...
    render(<LoginPage onLogin={noop} onRegister={onRegister} onReset={noop} />)
    fireEvent.click(screen.getByRole('button', { name: 'Registrarse' }))
